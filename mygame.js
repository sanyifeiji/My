...
window.onload=function(){
             ...
             //alert(arr);
              d0.style.backgroundColor=clist[iii][0];
              d1.style.backgroundColor=clist[iii][1];
              d2.style.backgroundColor=clist[iii][2];
              d3.style.backgroundColor=clist[iii][3];

             d0.innerHTML=nlist[iii][0];
             d1.innerHTML=nlist[iii][1];
             d2.innerHTML=nlist[iii][2];
             d3.innerHTML=nlist[iii][3];
